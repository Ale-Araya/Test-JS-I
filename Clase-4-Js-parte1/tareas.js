...
function dePalabrasAFrase(palabras) {
  ...
  // Tu código:
  // metodo 1 (callback)
  // let palabra = palabras.reduce(function(acumulador,elemento){
...
function agregarNumeros(numeros) {
  ...
  // return suma;
  //metodo2:
  let sumaDeNumeros = (acumulador, valorActual) => acumulador + valorActual;
  let total = numeros.reduce(sumaDeNumeros);
  return total;
}
